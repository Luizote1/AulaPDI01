...
server.get("/", (req, res) => {
  ...
  // Se nenhum parâmetro foi enviado, exibe apenas o formulário
    ...
    <html>
      <head>
        ...
        <style>
          ...
          p { font-size: 1.1em; }
          .valor { color: #2e8b57; font-size: 1.3em; font-weight: bold; }
          a { display: block; text-align: center; margin-top: 20px; color: #2e8b57; text-decoration: none; }
        </style>
      </head>
      <body>
        <div class="card">
